...
export const CandyMint: FC = () => {
    ...
    */
    ...
    }, [wallet.publicKey, connection, getUserSOLBalance, _showWL1, _showWL2, _showWL3, _pageNo, _o])
    ...
    console.log("Number(_o) + 25" + Number(_o) + 25)
        setO(Number(_o) + 25);
        ...
        <div className="mintDetails">
            <div>
                ...
                <div className='pageNum'>
                    {pageIndexer()}
                    <span onClick={() => arrowClicked} className='EachNumber'>></span>
                </div>
