      ...
      <div className="w-full flex flex-col items-center">
        ...
        <div className="w-full text-center">
          <h4 id="subCon" className="text-2xl md:text-4xl text-slate-300 my-2">
            Collection of 5,000 unique witches NFTs.
          </h4>
          <p className='text-slate-500 text-2xl leading-relaxed' id="subP">
            Witchezz Frenzy are a collection of 5,000 unique witches NFTs. They are digital artworks of the vivid creepy moods of witches here to be taken by you
          </p>
        </div>
      </div>
